package net.davio.create_aquatic_ambitions.compat.rei;
...
import net.davio.create_aquatic_ambitions.compat.rei.category.FanChannelingCategory;
...
public class CCAREI implements REIClientPlugin {
